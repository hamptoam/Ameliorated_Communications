...
namespace Ameliorated_Communications.Controllers
{
    public class PhonesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CalleeId,outgoingText")] Phone phone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CalleeId,outgoingText")] Phone phone)
        {
            if (id != phone.Id)
            {
                return NotFound();
